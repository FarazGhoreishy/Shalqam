...
class Ui_Dialog(object):
    def setupUi(self, Dialog, user, items):
        _translate = QtCore.QCoreApplication.translate

        Dialog.setObjectName("Dialog")
        Dialog.setFixedSize(860, 770)
        Dialog.setWindowTitle(_translate("Dialog", "Shalqam - Favorites Page"))
        ...
        self.favorite_label = QtWidgets.QLabel(Dialog)
        font = QtGui.QFont()
        font.setFamily("Josefin Slab")
        font.setPointSize(28)
        font.setBold(True)
        font.setWeight(75)
        self.favorite_label.setFont(font)
        self.favorite_label.setStyleSheet("QLabel{ width: 100%; height: 55px; background-color: #CA80DC; border-radius: 15px; padding: 0 35px 0 35px; color: #fff; line-height: 1.2;}")
        self.favorite_label.setAlignment(QtCore.Qt.AlignCenter)
        self.favorite_label.setObjectName("category_label")
        self.favorite_label.setText(_translate("Dialog", f"{user.first_name}'s Favorites"))

        self.verticalLayout.addWidget(self.favorite_label)
